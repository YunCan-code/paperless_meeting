...
export function UserManagement({ isTutor }: UserManagementProps) {
                ...
                <TableRow key={user.id} className="border-b-[#2A2A2A] hover:bg-[#1F1F1F]">
                  ...
                  <TableCell className="py-3 sm:py-4">
                    <span
                      className={`px-2 py-1 text-xs rounded-full ${
                        user.role === "tutor" ? "bg-[#FF6B00]/20 text-[#FF6B00]" : "bg-gray-600/20 text-gray-300"
                      }`}
                    >
                      {user.role}
                    </span>
                  ...
                  <TableCell className="py-3 sm:py-4">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="bg-[#1B1B1B] border-[#2A2A2A] text-[#EDEDED] mx-4 sm:mx-0 max-w-md sm:max-w-lg"
                      >
                        <DropdownMenuItem
